...
export function MobileLayout({
  ...
  return (
    <div className="min-h-screen bg-[#f9f9ff] text-[#121c2c] font-headline pb-24 text-left">
      ...
      <div className={`fixed left-1/2 -translate-x-1/2 z-40 select-none transition-all duration-300 ${
        selectedCompare.length > 0 ? 'bottom-36' : 'bottom-24'
      }`}>
        <button 
      ...
      {selectedCompare.length > 0 && (
        <div className="fixed bottom-24 left-4 right-4 z-40 bg-[#00535b] text-white py-3.5 px-5 rounded-3xl shadow-2xl flex items-center gap-4 border border-white/10 justify-between animate-in slide-in-from-bottom-5 duration-200">
          <div className="flex items-center gap-2.5 min-w-0">
            <span className="bg-white text-[#00535b] text-[10px] font-black w-5 h-5 rounded-full flex items-center justify-center shrink-0">
          ...
          <div className="flex gap-1.5 shrink-0">
            <button 
              ...
              className="text-white/70 hover:text-white text-[10px] font-bold uppercase tracking-wider transition-colors px-2 py-1"
            >
              Clear
            </button>
            <button 
              ...
              className={`px-4 py-2 rounded-full font-black text-[10px] uppercase tracking-wider transition-colors duration-150 shadow-sm ${
