...
export function Footer({ page, setPage }) {
  ...
  return (
    <>
      <footer className="bg-white border-t border-slate-100 w-full py-16 px-6 md:px-8 font-body text-left relative z-10">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-between items-start gap-12">
          ...
          <div className="flex-grow w-full md:w-auto text-left">
            <h5 className="font-headline font-black text-slate-800 text-sm tracking-wider uppercase mb-6">
              Important Links
            </h5>
            <div className="grid grid-cols-2 gap-x-8 gap-y-3.5 text-xs md:text-sm">
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left min-w-[260px] max-w-xs w-full lg:w-auto gap-10">
            {/* Follow Us */}
            <div className="w-full">
              <h5 className="font-headline font-black text-slate-800 text-sm tracking-wider uppercase mb-4 text-center lg:text-left">
                Follow Us
              </h5>
              <div className="flex gap-3 justify-center lg:justify-start">
                <a href="#" className="h-9 w-9 rounded-full bg-[#3b5998] hover:opacity-90 active:scale-95 transition-all text-white flex items-center justify-center shadow-sm">
                ...
                <a href="#" className="h-9 w-9 rounded-full bg-black hover:opacity-90 active:scale-95 transition-all text-white flex items-center justify-center shadow-sm">
                  <svg width="14" height="14" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                </a>
                <a href="#" className="h-9 w-9 rounded-full bg-[#0077b5] hover:opacity-90 active:scale-95 transition-all text-white flex items-center justify-center shadow-sm">
                  <svg width="14" height="14" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.779-1.75-1.75s.784-1.75 1.75-1.75 1.75.779 1.75 1.75-.784 1.75-1.75 1.75zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                </a>
                <a href="#" className="h-9 w-9 rounded-full bg-[#ff0000] hover:opacity-90 active:scale-95 transition-all text-white flex items-center justify-center shadow-sm">
                ...
                <a href="#" className="h-9 w-9 rounded-full bg-[#e1306c] hover:opacity-90 active:scale-95 transition-all text-white flex items-center justify-center shadow-sm">
            ...
            <div className="w-full flex flex-col items-center lg:items-start mt-2">
              {/* ChooseMyLab Logo */}
              <div className="flex items-center gap-2 justify-center lg:justify-start mb-6 select-none">
                <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-[#00a896]">
                ...
                <span className="text-2xl font-black text-[#00828a] tracking-tight font-headline">
                  ChooseMyLab
                </span>
              </div>
              ...
              <div className="relative mb-3">
                <svg width="140" height="140" viewBox="0 0 150 150" className="mx-auto drop-shadow-md">
                  <defs>
                    {/* Gold Gradients */}
              ...
              <p className="text-[#00828a] font-bold text-xs uppercase tracking-widest text-center lg:text-left pl-0 lg:pl-10">
                in Delhi NCR
              </p>
            </div>
          </div>
      ...
      <div className="bg-[#f8fafc] border-t border-slate-200/60 py-5 px-6 md:px-8 text-center text-xs text-slate-500 font-semibold relative z-10 w-full select-none">
